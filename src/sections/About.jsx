  ...
  return (
      <section className="c-space my-10" id="about">
        <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
            ...
            <div className="grid-container flex flex-col items-center justify-center text-center">
              ...
              <div>
                ...
                <p className="grid-subtext">
                  ...
                  passionate
                  about full-stack development and AI technologies. I love building innovative applications and
          ...
          <div className="col-span-1 xl:row-span-3">
            <div className="grid-container flex flex-col items-center justify-center text-center">
              ...
              <div>
                ...
                <p className="grid-subtext">
                  I specialize in Python, JavaScript, TypeScript, and Java, with experience building full-stack
                  applications using React, Next.js, Node.js, and various APIs. I work with databases like MongoDB and
                  PostgreSQL and am comfortable with Linux, Git, and CI/CD tools.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-1 xl:row-span-3">
            <div className="grid-container flex flex-col items-center justify-center">
              ...
              <div className="text-center">
                ...
                <p className="grid-subtext">I am based in Los Angeles, CA and open to relocate/remote work
                  worldwide.</p>
          ...
          <div className="xl:col-span-2 xl:row-span-2 flex justify-center items-center">
            <div className="grid-container flex flex-col justify-center items-center p-4 bg-white rounded-lg shadow-md">
              <img src="assets/grid3.png" alt="grid-3" className="w-full sm:h-[266px] h-fit object-contain mb-4"/>

              {/* Content Section */}
              <div className="text-center">
                {/* Header for Resume */}
                <p className="grid-headtext text-2xl font-bold">Resume</p>

                {/* Description Subtext */}
                {/* Uncomment this if you want the subtext */}
                {/* <p className="grid-subtext text-lg text-gray-600 mt-2">What I've Been Up To :)</p> */}
                ...
                <div className="mt-4">
                  <a
                      ...
                      className="inline-block px-4 py-2 text-white bg-blue-200 rounded-lg shadow-lg hover:bg-pink-300 transition duration-300"
                  >
                    View My Resume
                  </a>
                </div>
